...
class SalePaymentTerm(models.Model):
    ...
    payment_type = fields.Selection([('b', u'Ngân hàng'),('c', u'Tiền mặt'),('o', u'Khác')], string="Loại thanh toán", default='c')
    ...
    contract_order_id = fields.Many2one('sale.contract', string=u'Sale Contract')
